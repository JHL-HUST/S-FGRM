...
tf.flags.DEFINE_integer('number', 12, 'the number of images for variance tuning.')

tf.flags.DEFINE_float('beta', 1.5, 'the bound for variance tuning.')

tf.flags.DEFINE_float('gamma', 1.0, 'the ratio of the origin gradient.')
...
def graph(x, y, i, x_max, x_min, grad):
    ...
    noise = (global_grad + FLAGS.gamma * new_grad) / (1. * (FLAGS.number + FLAGS.gamma))
